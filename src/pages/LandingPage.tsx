      ...
      <header className="border-b border-[#222222] backdrop-blur-md bg-black/80 sticky top-0 z-50">
        <div className="container mx-auto px-6 py-4 flex justify-between items-center">
          <div className="flex items-center gap-2">
            <Skull className="text-[#C69B7B]" size={32} />
            <span className="text-2xl font-bold tracking-tight">SubPirate</span>
          </div>
                ...
                <div className="space-y-6 mb-10">
                  <div className="flex items-start gap-3">
                    ...
                    <p className="text-gray-300">
                      <span className="font-semibold text-white">Risk-free 14-day trial</span> - Experience the full platform with no commitment
                    </p>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-6 h-6 rounded-full bg-[#C69B7B]/20 flex items-center justify-center flex-shrink-0 mt-0.5">
                    ...
                    <p className="text-gray-300">
                      <span className="font-semibold text-white">Quick implementation</span> - Be operational in minutes, not days
                    </p>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-6 h-6 rounded-full bg-[#C69B7B]/20 flex items-center justify-center flex-shrink-0 mt-0.5">
                    ...
                    <p className="text-gray-300">
                      <span className="font-semibold text-white">30-day satisfaction guarantee</span> - Full refund available if not satisfied
                    </p>
                  </div>
                </div>
      ...
      <footer className="bg-black border-t border-[#222222] py-16">
        <div className="container mx-auto px-6">
          ...
          <div className="flex flex-col md:flex-row justify-between">
            <div className="mb-10 md:mb-0 md:max-w-xs">
              <div className="flex items-center gap-2 mb-4">
                ...
                <span className="text-xl font-bold">SubPirate</span>
              </div>
              ...
              <div className="flex space-x-4">
                <a href="#" className="w-10 h-10 rounded-full bg-[#111111] flex items-center justify-center text-gray-400 hover:bg-[#C69B7B]/20 hover:text-[#C69B7B] transition-colors">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-10">
              <div>
                ...
                <ul className="space-y-3">
                  <li><a href="#" className="text-gray-400 hover:text-[#C69B7B] transition-colors text-sm">About Us</a></li>
                  <li><a href="#" className="text-gray-400 hover:text-[#C69B7B] transition-colors text-sm">Success Stories</a></li>
                  <li><a href="#" className="text-gray-400 hover:text-[#C69B7B] transition-colors text-sm">Press</a></li>
                  <li><a href="#" className="text-gray-400 hover:text-[#C69B7B] transition-colors text-sm">Contact</a></li>
                </ul>
              </div>
              ...
              <div>
                ...
                <ul className="space-y-3">
                  <li><a href="#features" className="text-gray-400 hover:text-[#C69B7B] transition-colors text-sm">Features</a></li>
                  <li><a href="#pricing" className="text-gray-400 hover:text-[#C69B7B] transition-colors text-sm">Pricing</a></li>
                  <li><a href="#" className="text-gray-400 hover:text-[#C69B7B] transition-colors text-sm">ROI Calculator</a></li>
                  <li><a href="#" className="text-gray-400 hover:text-[#C69B7B] transition-colors text-sm">Knowledge Base</a></li>
                </ul>
              </div>
              ...
              <div>
                ...
                <ul className="space-y-3">
                  <li><a href="#" className="text-gray-400 hover:text-[#C69B7B] transition-colors text-sm">Privacy Policy</a></li>
                  <li><a href="#" className="text-gray-400 hover:text-[#C69B7B] transition-colors text-sm">Terms of Service</a></li>
                  <li><a href="#" className="text-gray-400 hover:text-[#C69B7B] transition-colors text-sm">GDPR Compliance</a></li>
                  <li><a href="#" className="text-gray-400 hover:text-[#C69B7B] transition-colors text-sm">Security</a></li>
                </ul>
              </div>
            </div>
          </div>
          ...
          <div className="border-t border-[#222222] mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-500 text-sm mb-4 md:mb-0">© 2023 SubPirate. All rights reserved. Results may vary. This platform is designed for educational purposes.</p>
            <div className="flex items-center gap-4">
              <a href="#" className="text-gray-400 hover:text-[#C69B7B] transition-colors text-sm">Status</a>
              <span className="text-gray-700">•</span>
              <a href="#" className="text-gray-400 hover:text-[#C69B7B] transition-colors text-sm">Support</a>
            </div>
          </div>
        </div>
      </footer>
